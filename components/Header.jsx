    ...
    <header className="text-white sticky top-0 flex mx-8 p-4 item-start justify-between z-10 ">
      ...
      >
        ...
        <SocialIcon
          ...
          bgColor="transparent"
          target="blank"
          className="my-social-icon hover:scale-125  bg-transparent "
        />

        <SocialIcon
          url="https://github.com/shambhav15"
          fgColor="grey"
          bgColor="transparent"
          target="blank"
        ...
        <SocialIcon
          url="https://www.instagram.com/shandilya_15/"
          fgColor="grey"
          bgColor="transparent"
          target="blank"
          className="my-social-icon hover:scale-125 hover:blue-500 bg-transparent"
        ...
        <SocialIcon
          url="https://twitter.com/Shambhav_15"
          fgColor="grey"
          bgColor="transparent"
          target="blank"
          className="my-social-icon hover:scale-125 hover:blue-500 bg-transparent"
      ...
      <a href="mailto:shambhavse15@gmail.com" target="blank">
        ...
        >
          ...
          <p className="px-10 uppercase hidden md:inline-flex text-sm text-white cursor-pointer">
            Get in Touch
          </p>
        </motion.div>
      </a>
